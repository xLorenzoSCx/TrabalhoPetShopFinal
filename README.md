...
1. **Clone o repositório**:
   ```bash
   git clone [[https://github.com/seu-usuario/nome-do-repositorio.git](https://github.com/xLorenzoSCx/TrabalhoPetShopFinal)](https://github.com/seu-usuario/nome-do-repositorio.git)
   ```
